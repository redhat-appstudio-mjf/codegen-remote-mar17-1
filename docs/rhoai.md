...
3) Access the `workbench` named `codegen-remote-mar17-1-notebook`.
...
5) In the terminal, run `cd codegen-remote-mar17-1` to navigate to your sample app's directory.
